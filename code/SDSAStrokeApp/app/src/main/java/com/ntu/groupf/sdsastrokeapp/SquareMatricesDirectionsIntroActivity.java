...
public class SquareMatricesDirectionsIntroActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_square_matrices_directions_intro);
